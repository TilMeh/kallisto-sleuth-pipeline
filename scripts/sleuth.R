...
print("Creating plot")
plot_bootstrap(so, "Replace this text", units = "est_counts", color_by = "condition")
#sleuth_plot <- plot_bootstrap(so, "Replace this text", units = "est_counts", color_by = "condition")
print("Saving plot")
